 ...
 * 
 * NOTE: These tests are temporarily skipped as they test legacy Cursor behavior.
 * The multi-assistant architecture in v1.5.0 changes how Cursor support works.
 * These tests need to be updated to reflect the new assistant adapter system.
 */
describe.skip('CLI Cursor Integration Tests', () => {
  let testDir: string;
